...
class AAPG_Hub_Maker {
    ...
    public static function generate_with_streaming(
        ...
        // Remove page_title from schema and required, we do not want to send it through OpenAI API!
        // unset($schema['properties']['page_title']);
        // if (isset($schema['required']) && is_array($schema['required'])) {
        //     $schema['required'] = array_values(array_diff($schema['required'], ['page_title']));
        // }
        ...
        $inner_callback = function ($event_type, $decoded) use (
            ...
            if ($event_type === 'response.completed') {
                ...
                // Inject page title and slug here, since we do not want AI to decide these fields at all!
                $final_data['page_title'] = $page_title;
